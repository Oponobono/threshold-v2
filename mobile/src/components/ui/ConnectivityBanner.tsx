...
export const ConnectivityBanner: React.FC = () => {
  ...
  const getMessage = () => {
    switch (state) {
      case 'offline':
        return pendingCount > 0 ? t('common.offlineWithCount', { count: pendingCount }) : t('common.offline');
      case 'syncing':
        return syncMessage || t('common.syncing');
      case 'success':
        return syncMessage || t('common.syncComplete');
      default:
        return '';
    }
  };
