...
exports.deltaSync = (req, res) => {
  ...
  const regularTables = ['courses', 'subjects', 'assessments', 'schedules', 'flashcard_decks', 'flashcards', 'calendar_events', 'grading_periods', 'lms_accounts', 'subject_threshold_overrides', 'study_sessions', 'audio_recordings', 'scanned_documents', 'youtube_videos', 'ai_chats', 'study_notes', 'document_anchors'];
